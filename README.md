...
For "how-to-use" information take a look at comprehensive [example](http://resnyanskiy.github.io/js.tree/index.html) (.ts script files are more descriptive, use browser "Developer Tools" with enabled source maps). 